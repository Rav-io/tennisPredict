...
def predict_by_glicko_hyper(player1_id, player2_id, player_1_glicko, player_2_glicko, surface):
    model_filename = 'tennis_model_trained_hyperparameter_tuned_glicko_with_surface.joblib'
...
def predict_by_glicko_hyper_gb(player1_id, player2_id, player_1_glicko, player_2_glicko, surface):
    model_filename = 'tennis_model_trained_hyperparameter_tuned_glicko_with_surface_gb.joblib'
    model = joblib.load(model_filename)
