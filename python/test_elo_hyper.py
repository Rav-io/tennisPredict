...
def predict_by_elo(player1_id, player2_id, player1_elo, player2_elo, surface):
    model_filename = 'tennis_model_trained_hyperparameter_tuned_elo_with_surface.joblib'
    ...
    feature_columns = ['player1_id', 'player2_id', 'player1_elo', 'player2_elo'] + surface_columns
...
def predict_by_elo_gb(player1_id, player2_id, player1_elo, player2_elo, surface):
    model_filename = 'tennis_model_trained_hyperparameter_tuned_elo_with_surface_gb.joblib'
    model = joblib.load(model_filename)
...
'''model_filename = 'model/tennis_model_trained_hyperparameter_tuned_elo_with_surface_gb.joblib'
model = joblib.load(model_filename)
